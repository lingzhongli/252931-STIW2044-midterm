...
import 'package:my_hires/payment.dart';
import 'package:my_hires/registrationscreen.dart';
import 'package:my_hires/splashscreen.dart';
...
String urluploadImage =
    "http://hireelectrian.com/my_hire/php/upload_imageprofile.php";
String urlupdate = "http://hireelectrian.com/my_hire/php/update_profile.php";
File _image;
int number = 0;
String _value;
                                    ...
                                    decoration: new BoxDecoration(
                                        ...
                                        image: new DecorationImage(
                                            ...
                                            image: new NetworkImage(
                                                "http://hireelectrian.com/my_hire/profile/${widget.user.email}.jpg?dummy=${(number)}'")))),
                              ),
                              SizedBox(height: 5),
                              Container(
                                child: Text(
