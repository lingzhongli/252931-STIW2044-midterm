...
class _DetailInterfaceState extends State<DetailInterface> {
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
          ...
          height: 200,
          child: Image.network(
              'http://hireelectrian.com/my_hire/images/${widget.job.jobimage}.jpg',
              fit: BoxFit.fill),
        ),
        SizedBox(
          height: 10,
  ...
  void _showDialog() {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          title: new Text("EDIT " + widget.job.jobtitle),
  ...
  Future<String> acceptRequest() async {
    String urlLoadJobs = "http://hireelectrian.com/my_hire/php/accept_job.php";
